...
class MockApiService {
  ...
  private async generateMockCsvContent(job: GenerationJob): Promise<string> {
    ...
    const defaultPlacements = "Default, Default, Default, Default, audience_network classic, facebook biz_disco_feed, facebook facebook_reels, facebook facebook_reels_overlay, facebook feed, facebook instream_video, facebook marketplace, facebook right_hand_column, facebook search, facebook story, facebook video_feeds, instagram explore, instagram reels, instagram story, instagram stream, messenger story";
    ...
    for (const location of locations) {
      for (const template of templates) {
        ...
        const rowData = {
          ...
          adName: adName,
          dynamicCreativeAdFormat: REFERENCE_AD_TEMPLATE.dynamicCreativeAdFormat,
          ...
          additionalImage1Hash: "303541819130038:0642b7ec8b997de13d35e3760f43ee2e",
          ...
          additionalVideo1Placement: REFERENCE_AD_TEMPLATE.additionalVideoPlacement,
