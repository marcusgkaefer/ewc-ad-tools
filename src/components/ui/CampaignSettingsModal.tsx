        ...
        >
          ...
          <div className="px-8 py-6 border-b border-neutral-200">
            ...
            <p className="text-neutral-600 mt-2">
              Configure your Meta campaign parameters. These settings will be
              applied to all generated campaigns.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="space-y-2">
                ...
                <ModernDatePicker
                  ...
                  onChange={(date: Date) =>
                    setConfig(prev => ({ ...prev, selectedDate: date }))
                  }
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onChange={value =>
                    setConfig(prev => ({ ...prev, objective: value }))
                  }
