    ...
    >
      ...
      <div className="flex justify-between items-center gap-2 max-w-4xl mx-auto">
        {steps.map(step => {
          ...
          const isClickable =
            step.completed || isActive || step.id < currentStep;
          ...
          return (
            ...
            >
              {/* Step Icon Circle */}
              <div
                className={`w-12 h-12 rounded-full border-2 flex items-center justify-center transition-all duration-300 relative overflow-hidden mb-3 shadow-lg ${
                  isActive
